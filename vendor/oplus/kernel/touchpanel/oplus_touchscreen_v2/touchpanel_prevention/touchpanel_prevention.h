...
struct grip_monitor_data{
	u64 exit_match_y_times;
	u64 exit_match_x_times;
	...
	u64 corner_exit_dis_match_times;
	u64 corner_press_exit_match_times;
...
struct kernel_grip_info {
	...
	uint16_t                  finger_hold_differ_size_x;              /*finger hold different y po*/
